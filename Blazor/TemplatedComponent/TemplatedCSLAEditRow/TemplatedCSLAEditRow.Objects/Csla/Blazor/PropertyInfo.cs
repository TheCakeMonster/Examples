...
namespace TemplatedCSLAEditRow.Objects.Blazor
{
    ...
    public class PropertyInfo<P> : INotifyPropertyChanged
    {
        ...
        public string FriendlyName
        {
            get
            {
                var pi = Csla.Core.FieldManager.PropertyInfoManager.GetRegisteredProperty(Model.GetType(), PropertyName);
        ...
        public string ErrorText
        {
            get
            {
                ...
                if (Model is Csla.Core.BusinessBase obj)
        ...
        public bool CanRead
        {
            get
            {
                if (Model is Csla.Security.IAuthorizeReadWrite obj)
