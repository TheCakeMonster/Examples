...
{
	public class MixedModeAuthorizationMessageHandler : DelegatingHandler, IDisposable
	{
		public MixedModeAuthorizationMessageHandler(IAccessTokenProvider provider, NavigationManager navigationManager)
		{
            _provider = provider;
        ...
        public MixedModeAuthorizationMessageHandler ConfigureHandler(
